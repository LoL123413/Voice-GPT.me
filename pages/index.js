...
<div style={{
  ...
  <p className={styles.main}>I do NOT control and am not responsible for the responses generated by VoiceGPT. This application uses the OpenAI API. <br /> Made with ❤ by perko#6901</p>
  </div>
      </main>
